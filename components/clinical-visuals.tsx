...
export function ClinicalWorkflowMockup() {
  ...
  return (
    <div className="relative mx-auto w-full min-w-0 max-w-2xl">
      <div className="absolute -inset-6 rounded-[32px] bg-[radial-gradient(circle_at_30%_20%,rgba(24,183,201,0.22),transparent_34%),radial-gradient(circle_at_80%_60%,rgba(23,50,77,0.16),transparent_38%)] blur-2xl" />
      <div className="relative overflow-hidden rounded-[28px] border border-navy/10 bg-white shadow-[0_28px_90px_rgba(23,50,77,0.18)]">
        <div className="flex items-center justify-between gap-4 border-b border-navy/10 bg-[#F8FBFC] px-4 py-3">
        ...
        <div className="grid min-h-[440px] grid-cols-[74px_1fr] bg-white sm:grid-cols-[128px_1fr]">
          <aside className="border-r border-navy/10 bg-navy px-2 py-4 text-white sm:px-3">
            ...
            <div className="grid gap-2">
              {["Dashboard", "Clients", "Assessments", "Care Plans", "Documents"].map((item) => (
                <div className={`rounded-lg px-2 py-2 text-[10px] font-bold sm:text-xs ${item === "Assessments" ? "bg-white text-navy" : "text-white/58"}`} key={item}>
                  {item}
                </div>
              ))}
            </div>
          ...
          <div className="min-w-0 p-4 sm:p-5">
            <div className="flex min-w-0 flex-col gap-3 border-b border-navy/10 pb-4 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-teal">Assessment Workspace</p>
                <h3 className="mt-1 text-xl font-black tracking-tight text-navy sm:text-2xl">Demo Client Clinical Review</h3>
            ...
            <div className="mt-4 grid gap-3 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="rounded-xl border border-navy/10 bg-white p-3 shadow-sm">
                ...
                <div className="grid gap-2">
                  {sections.map(([section, state, note]) => (
                    <div className="rounded-lg border border-navy/10 bg-[#FBFCFD] p-3" key={section}>
              ...
              <div className="grid gap-3">
                <div className="rounded-xl bg-navy p-4 text-white shadow-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-white/70">Generated comments remain draft until reviewed and finalized by the RN.</p>
                </div>
                <div className="rounded-xl border border-teal/25 bg-[#EDF6FA] p-4">
        ...
        <div className="grid border-t border-navy/10 bg-[#F8FBFC] sm:grid-cols-4">
