...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-white px-4 pb-5 pt-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[30px] border border-white/10 bg-[radial-gradient(circle_at_12%_0%,rgba(94,210,221,0.2),transparent_34%),radial-gradient(circle_at_92%_18%,rgba(255,255,255,0.08),transparent_30%),linear-gradient(135deg,#0F2740_0%,#102A43_62%,#0B3448_100%)] text-white shadow-[0_30px_96px_rgba(16,42,67,0.28)]">
        <div className="grid gap-10 px-5 py-10 sm:px-8 lg:grid-cols-[1.25fr_1fr_0.85fr] lg:px-10 lg:py-12">
          <div>
            ...
            <div className="mt-7 grid gap-2 rounded-2xl border border-white/15 bg-white/9 p-4 text-sm backdrop-blur">
          ...
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#5ED2DD]">Services</p>
            <ul className="mt-5 grid gap-2.5 break-words text-sm text-[#D6E1EA]">
              {services.map((service) => <li key={service}>{service}</li>)}
            </ul>
          </div>
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#5ED2DD]">Company</p>
            <ul className="mt-5 grid gap-2.5 break-words text-sm text-[#D6E1EA]">
            ...
            <div className="mt-6 rounded-2xl border border-[#5ED2DD]/30 bg-white/9 p-4 text-xs font-semibold leading-5 text-[#D6E1EA]">
              No detailed medical information should be submitted through public website forms.
            </div>
          </div>
        </div>
        <div className="border-t border-white/12 px-5 py-5 text-center text-xs leading-6 text-[#AFC1CF] sm:px-8 lg:px-10">
