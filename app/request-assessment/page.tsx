...
const fieldClass = "mt-2 w-full rounded-lg border border-navy/15 bg-white px-3 py-3 text-navy outline-none transition placeholder:text-slate/60 focus:border-teal focus:ring-4 focus:ring-teal/15";
    ...
    <main>
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="rounded-2xl bg-navy p-6 text-white shadow-soft">
          ...
          <form className="grid gap-5 rounded-2xl border border-navy/10 bg-white p-6 shadow-soft" method="get" action="/contact">
            <div className="rounded-xl border border-alert/25 bg-[#fff8f8] p-4 text-sm font-semibold leading-6 text-alert">
            ...
            <label className="font-bold text-navy">General notes<textarea className={`${fieldClass} min-h-32`} name="notes" placeholder="Do not include diagnoses, medications, Social Security numbers, insurance identifiers, or detailed resident medical information." /></label>
            ...
            <button className="inline-flex min-h-12 w-full items-center justify-center rounded-lg bg-navy px-5 py-3 text-sm font-extrabold text-white transition hover:bg-[#214562] sm:w-fit" type="submit">
              Send Request
            </button>
          </form>
        </div>
