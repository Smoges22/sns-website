...
export default function SampleDocumentsPage(){return <PageShell><PageHero eyebrow="Sample Documents" title="Explore fictional SNS document samples" intro="Review polished examples of the structure SNS uses for RN assessments and individualized care plans."/><SampleDocumentsSection className="bg-[#F7FAFB]"/><FinalCta/></PageShell>}
